Ansh Pachauri
Anshpachauri2005@gmail.com | +1 6144939393 | LinkedIn(http://www.linkedin.com/in/ansh-pachauri) | GitHub(https://github.com/anshpachauri23/Portfolio) | Portfolio Website(https://personal-portfolio-tau-navy.vercel.app/)
EDUCATION
The Ohio State University, College of Engineering Bachelor’
s of Science in Computer Science and Engineering Expected Graduation Date: May 2026
GPA: 3.6/4.0
...
• Developed and optimized machine learning models, implementing Naive Bayes (with pseudo-counts for sparse data) and linear classifiers
(Logistic Regression, Perceptron), to achieve sentiment, tweet, and binary classification across multiple datasets, demonstrating proficiency in
advanced data representation (Bag-of-Words) and optimization (batch gradient descent).
PeerEval - Academic Assessment Platform (Ruby on Rails 7.2, SQLite3, Bootstrap 5, Hotwire) August 2024 – December 2024
• Architected and developed a comprehensive peer evaluation system for academic institutions, featuring role-based authentication (instructor/student), 
course management, homework assignment creation, file upload system with Active Storage, and automated grading workflows.
• Implemented modern Rails 7.2 architecture with Hotwire (Turbo + Stimulus) for dynamic user interfaces, Bootstrap 5 for responsive design, 
Devise authentication, and SQLite3 database with ActiveRecord ORM, demonstrating full-stack development proficiency without Node.js dependencies.
...
• Frameworks/Libraries: Node.js, React, Next.js, Ruby on Rails 7.2, Hotwire (Turbo + Stimulus), Bootstrap 5, Tailwind CSS, TensorFlow, OpenCV, NumPy, Agile
• Cloud & Tools: AWS (Lambda, Bedrock, Lex, S3, RDS, EC2, DynamoDB, API Gateway), Jupyter Notebook, GitHub, Eclipse, MySQL,
PostgreSQL, SQLite3, Devise, Active Storage, MATLAB
