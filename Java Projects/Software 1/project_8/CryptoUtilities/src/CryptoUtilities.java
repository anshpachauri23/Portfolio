...
public final class CryptoUtilities {
    ...
    public static boolean isEven(NaturalNumber n) {
        ...
        //checking if n mod 2 is equal to 0
    ...
    public static boolean isWitnessToCompositeness(NaturalNumber w,
        ...
        NaturalNumber wTemp1 = new NaturalNumber2(w);
        NaturalNumber wTemp2 = new NaturalNumber2(w);
        nMinusOne.decrement();

        powerMod(wTemp1, two, n);
        powerMod(wTemp2, nMinusOne, n);

        if (wTemp1.compareTo(one) == 0 || wTemp2.compareTo(one) != 0) {
            witness = true;
        }
    ...
    public static boolean isPrime2(NaturalNumber n) {
        ...
        if (n.compareTo(new NaturalNumber2(THREE)) <= 0) {
            ...
            NaturalNumber nMinusOne = new NaturalNumber2(nTemp);
            nMinusOne.decrement();
            for (int i = 0; i <= 40; i++) {
                NaturalNumber witness = randomNumber(nTemp);
                //isWitnessToCompositeness requires: n > 2 and 1 < w < n - 1
                if (n.compareTo(two) > 0 && witness.compareTo(one) > 0
                        && witness.compareTo(nMinusOne) < 0) {
                    prime = !isWitnessToCompositeness(witness, n);
                }
            }
        }
        /*
