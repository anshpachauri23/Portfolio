...
public abstract class ListTest {
    ...
    /*
     * Test for Retreat Left empty
     */
    @Test
    public final void testRetreatLeftEmpty() {
        /*
         * Set up variables
         */
        List<String> list1 = this.createFromArgsTest(1, "red", "yellow");
        List<String> list2 = this.createFromArgsRef(0, "red", "yellow");
        /*
         * Call method under test
         */
        list1.retreat();
    ...
    /*
     * Test for Retreat left non empty
     */
    @Test
    public final void testRetreatLeftNonEmpty1() {
        /*
         * Set up variables
         */
        List<String> list1 = this.createFromArgsTest(3, "red", "yellow",
                "green");
        List<String> list2 = this.createFromArgsRef(2, "red", "yellow",
                "green");
        /*
         * Call method under test
         */
     ...
     */
    @Test
    public final void testRetreatLeftNonEmpty2() {
        /*
         * Set up variables
         */
        List<String> list1 = this.createFromArgsTest(4, "red", "yellow",
                "green", "orange");
        List<String> list2 = this.createFromArgsRef(3, "red", "yellow", "green",
                "orange");
        /*
         * Call method under test
         */
