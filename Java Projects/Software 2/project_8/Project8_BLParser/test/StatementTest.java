...
public abstract class StatementTest {
     ...
     */
    @Test(expected = RuntimeException.class)
    public final void testParseErrorNotCompleteLoop() {
        /*
         * Setup
         */
        Statement sTest = this.constructorTest();
     ...
     */
    @Test(expected = RuntimeException.class)
    public final void testParseErrorPythonSyntax() {
        /*
         * Setup
         */
        Statement sTest = this.constructorTest();
     ...
     */
    @Test(expected = RuntimeException.class)
    public final void testParseErrorJavaStyle() {
        /*
         * Setup
         */
        Statement sTest = this.constructorTest();
     ...
     */
    @Test
    public final void testParseValidEmptyLoop() {
        /*
         * Setup
         */
        Statement sRef = this.constructorRef();
     ...
     */
    @Test
    public final void testParseValidBestBugLogic() {
        /*
         * Setup
         */
        Statement sRef = this.constructorRef();
     ...
     */
    @Test(expected = RuntimeException.class)
    public final void testParseErrorIncorrectCommand() {
        /*
         * Setup
         */
        Statement sTest = this.constructorTest();
