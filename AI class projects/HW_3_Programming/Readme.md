...
* Carmen submission:
**Submit one .zip file named HW3_programming_<name>_<number>.zip** (e.g., HW3_programming_chao_209.zip), which contains the following files
...
* The slide [HW_3_How_To.pptx](./HW_3_How_To.pptx) provides some further instruction about this assignment.
...
* Please use python3 (3.11) and write your own solutions from scratch. You may need NumPy.
...
# Naive Bayes Classification (35 pts)
...
* Note that, the autograder is to check your implementation semantics. If you have syntax errors, you may get python error messages before you can see the auto_graders' results.
...
* Now, can you think of a way to get an even higher accuracy by resolving this warning?

* Hint: think about what causes the warning, and what this warning means for a test sentence. See the pseudo count in the slides in estimating the parameters. Do you think it will help resolve the problem?
...
* After implementation, you may run the following command to test your implementation
`python3 NaiveBayes_improved.py`

You should see exactly the same output format as `python3 NaiveBayes.py`.
